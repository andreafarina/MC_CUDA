function [] = MC_FuncGenInputFile(FILE,FILE_OUT_PREFIX,...
                NPHOTONS,TMAX,RorT,Radius,Rho,opt)
...
%% Data 
%FILE_OUT_PREFIX='Simulations/Thyroid/THY';
EXT_OUT = 'mco';
NRUN = size(opt,3);
%NPHOTONS=10000000;
%TMAX=8000;%2.0345*4096;%2000 %ps
%RorT='R';
%Radius=1000;%2.54/2;
...
n_up = 1.0;%refractive index up
n_down = 1.0;%refractive index down

%opt0=[1.33 0 MUS0 g 1.0
%    1.54 0 MUS0 g 1.0];
%opt=[1.46 0 MUS0 g 100];
%opt0 = opt;
NLAY=size(opt,1);
...
for i=1:NRUN
    ...
    for k=1:NLAY
        ...
        opt0(k,1),opt0(k,2),opt0(k,3),opt0(k,4),opt0(k,5),k');
